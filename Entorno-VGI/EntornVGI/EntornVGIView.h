...
// Entorn VGI: Vista Ortogràfica
	float ortoScale = 1;

// Entorn VGI: OBJ AEROPORT
	//bool aeroportFinger[FINGER_SIZE];
...
public:
	...
	afx_msg void OnIluminacioTexturaFusta();
	afx_msg void OnUpdateIluminacioTexturaFusta(CCmdUI *pCmdUI);
	afx_msg void OnIluminacioTexturaMarbre();
	afx_msg void OnUpdateIluminacioTexturaMarbre(CCmdUI *pCmdUI);
	afx_msg void OnIluminacioTexturaMetall();
	afx_msg void OnUpdateIluminacioTexturaMetall(CCmdUI *pCmdUI);
	afx_msg void OnObjecteFinger();
	afx_msg void OnUpdateObjecteFinger(CCmdUI *pCmdUI);
	afx_msg void OnObjectePista();
	afx_msg void OnUpdateObjectePista(CCmdUI *pCmdUI);
	afx_msg void OnAeroportFinger();
	afx_msg void OnUpdateAeroportFinger(CCmdUI *pCmdUI);
	afx_msg void OnAeroportFinger1();
	afx_msg void OnUpdateAeroportFinger1(CCmdUI *pCmdUI);
	afx_msg void OnAeroportFinger2();
	afx_msg void OnUpdateAeroportFinger2(CCmdUI *pCmdUI);
	afx_msg void OnAeroportFinger3();
	afx_msg void OnUpdateAeroportFinger3(CCmdUI *pCmdUI);
	afx_msg void OnAeroportFinger4();
	afx_msg void OnUpdateAeroportFinger4(CCmdUI *pCmdUI);
